...
//        validRequest = new GetFollowingRequest(new AuthToken(), currentUser.getAlias(), 3, null);
//        invalidRequest = new GetFollowingRequest(null, null, 0, null);
//
...
//        successResponse = new GetFollowingResponse(success_followees, false);
//
//        failureResponse = new GetFollowingResponse("An exception occurred");
//
...
//
//        @Override
//        public void getItemSucceeded(List<User> items, User lastItem, boolean hasMorePages) {
//            this.success = true;
//            this.message = null;
...
//    }
//
//    private FollowService setupFollowingServiceSpy(GetFollowingResponse serverFacadeResponse) {
...
//    }
//
//    private static void assertEquals(GetFollowingResponse response, FollowServiceObserver observer) {
...
//
//        followServiceSpy.getFollowing(validRequest);
//        awaitCountDownLatch();
//
...
//
//        followServiceSpy.getFollowing(invalidRequest);
//        awaitCountDownLatch();
//
