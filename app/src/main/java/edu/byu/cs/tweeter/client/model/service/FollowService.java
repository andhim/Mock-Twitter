...
public class FollowService {
    ...
    public interface GetFollowingObserver {
        void getFollowingSucceeded(List<User> users, User lastFollowee, boolean hasMorePages, boolean isLoading);
    ...
    private class GetFollowingHandler extends Handler {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if (success) {
                ...
                observer.getFollowingSucceeded(followees, lastFollowee, hasMorePages, isLoading);
